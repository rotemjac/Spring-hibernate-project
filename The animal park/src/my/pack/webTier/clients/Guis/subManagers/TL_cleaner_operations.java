...
public class TL_cleaner_operations extends JPanel {
	...
	public JScrollPane create_table (String operation) {
		...
		case ("Get details of all cleaners"):

			workers_list=mController.getTl_cleaner_Service().GetYourStaff("TL_cleaner");
